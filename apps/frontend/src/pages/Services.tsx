const departments = [
  ...
  },
  {
    ...
    link: { label: "اطّلع على دوراتنا التدريبية ←", href: "/trainings" },
  },
  {
    title: "قسم الأمن السيبراني والجرائم الإلكترونية",
    intro: "استشارات ودفوع متخصصة في قضايا الجرائم الإلكترونية، مع فهم تقني عميق لطبيعة الأدلة الرقمية.",
    items: [
      "قضايا الجرائم الإلكترونية والابتزاز الإلكتروني",
      "حماية البيانات والخصوصية الرقمية",
      "الاستشارات القانونية لأمن المعلومات",
      "التعامل مع الأدلة الرقمية والتقنية أمام النيابة والمحاكم",
    ],
  },
  {
    title: "قسم بحث علمي",
    intro: "دعم بحثي وأكاديمي متخصص لطلبة وباحثي القانون، من اختيار الموضوع لحد المناقشة.",
    items: [
      "إعداد الأبحاث والرسائل العلمية في مختلف فروع القانون",
      "التوثيق القانوني وفق الأصول الأكاديمية",
      "مراجعة وتدقيق الأبحاث قبل التقديم أو النشر",
      "الاستشارة العلمية لطلبة الدراسات العليا",
    ],
  },
  {
    title: "قسم محاسبة",
    intro: "خدمات محاسبية ومالية متكاملة تواكب الجانب القانوني لأي نشاط تجاري أو شركة.",
    items: [
      "إعداد ومراجعة الحسابات الختامية",
      "الاستشارات الضريبية والمحاسبية",
      "متابعة الإقرارات الضريبية والتعامل مع مصلحة الضرائب",
      "الدعم المحاسبي المصاحب لتأسيس وتصفية الشركات",
    ],
  },
  {
    title: "قسم تحكيم",
    intro: "تسوية المنازعات التجارية والمدنية بعيدًا عن ساحات القضاء، بسرعة وسرية وكفاءة.",
    items: [
      "التحكيم التجاري والمدني",
      "صياغة شروط ومشارطات التحكيم",
      "تمثيل الأطراف أمام هيئات التحكيم المحلية والدولية",
  ...
  return (
    <div>
      ...
      <section className="bg-(--color-navy) px-6 py-16 text-center">
        ...
        <a href="/contact?type=LEGAL_CONSULTATION" className="mt-7 inline-block rounded-md bg-(--color-gold) px-8 py-4 text-sm font-bold text-(--color-navy) hover:bg-(--color-gold-dim)">
          احجز استشارتك الآن
        </a>
      </section>
    </div>
